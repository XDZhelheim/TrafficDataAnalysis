...
if __name__ == "__main__":
    ...
    df=pd.read_csv("./data/chengdushi_1001_1010.csv", nrows=num_of_cars, header=0, names=["track"], usecols=[2],iterator=True)
    ...
    for times in range(20):
        ...
        for temp in sep_df["track"]:
            ...
            for item in temp:
                ...
                item[2] = int(item[2])
            track.append(temp)
        with open("./data/track_" + str(cnt) + "_cars.json", "w") as f:
            json.dump(track, f)
        cnt += sep_df.shape[0]
        print(times)
